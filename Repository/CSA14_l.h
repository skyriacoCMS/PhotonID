...
// Sun Jul 20 21:53:53 2014 by ROOT version 5.34/10
// from TTree EventTree/Event data
// found on file: /cms/kyriacou/Samples/Photons/job_spring14_gjet_pt20to40_20bx25.root
//////////////////////////////////////////////////////////
...
public :
   ...
   vector<float>   *eleSigmaIEtaIEta2012;
   ...
   vector<float>   *phoSigmaIEtaIEta2012;
   vector<float>   *phoSigmaIEtaIPhi2012;
   vector<float>   *phoSigmaIPhiIPhi2012;
   vector<float>   *phoE1x32012;
   vector<float>   *phoE2x22012;
   vector<float>   *phoE2x5Max2012;
   vector<float>   *phoE5x52012;
   ...
   TBranch        *b_eleSigmaIEtaIEta2012;   //!
   ...
   TBranch        *b_phoSigmaIEtaIEta2012;   //!
   TBranch        *b_phoSigmaIEtaIPhi2012;   //!
   TBranch        *b_phoSigmaIPhiIPhi2012;   //!
   TBranch        *b_phoE1x32012;   //!
   TBranch        *b_phoE2x22012;   //!
   TBranch        *b_phoE2x5Max2012;   //!
   TBranch        *b_phoE5x52012;   //!
...
#ifdef CSA14_l_cxx
CSA14_l::CSA14_l(TTree *tree) : fChain(0){
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/cms/kyriacou/Samples/Photons/job_spring14_gjet_pt20to40_20bx25.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/cms/kyriacou/Samples/Photons/job_spring14_gjet_pt20to40_20bx25.root");
      }      
      TDirectory * dir = (TDirectory*)f->Get("/cms/kyriacou/Samples/Photons/job_spring14_gjet_pt20to40_20bx25.root:/ggNtuplizer");     
...
Int_t CSA14_l::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CSA14_l::LoadTree(Long64_t entry)
{
...
void CSA14_l::Init(TTree *tree)
{
   ...
   phoE5x5 = 0;
   phoESEffSigmaRR = 0;
   phoSigmaIEtaIEta2012 = 0;
   phoSigmaIEtaIPhi2012 = 0;
   phoSigmaIPhiIPhi2012 = 0;
   phoE1x32012 = 0;
   phoE2x22012 = 0;
   phoE2x5Max2012 = 0;
   phoE5x52012 = 0;
   ...
   fChain->SetBranchAddress("eleSigmaIEtaIEta2012", &eleSigmaIEtaIEta2012, &b_eleSigmaIEtaIEta2012);
   ...
   fChain->SetBranchAddress("phoSigmaIEtaIEta2012", &phoSigmaIEtaIEta2012, &b_phoSigmaIEtaIEta2012);
   fChain->SetBranchAddress("phoSigmaIEtaIPhi2012", &phoSigmaIEtaIPhi2012, &b_phoSigmaIEtaIPhi2012);
   fChain->SetBranchAddress("phoSigmaIPhiIPhi2012", &phoSigmaIPhiIPhi2012, &b_phoSigmaIPhiIPhi2012);
   fChain->SetBranchAddress("phoE1x32012", &phoE1x32012, &b_phoE1x32012);
   fChain->SetBranchAddress("phoE2x22012", &phoE2x22012, &b_phoE2x22012);
   fChain->SetBranchAddress("phoE2x5Max2012", &phoE2x5Max2012, &b_phoE2x5Max2012);
   fChain->SetBranchAddress("phoE5x52012", &phoE5x52012, &b_phoE5x52012);
...
void CSA14_l::Show(Long64_t entry)
{
...
Int_t CSA14_l::Cut(Long64_t entry)
{
