...
public :
   ...
   Float_t         gedPhPt;
   Float_t         gedPhSieie;
   Float_t         gedPhSieie2012;
   Float_t         gedPhTower;
   Float_t         gedPhisPrompt;
   Float_t         gedPhoIso;
   Float_t         gedChgIso;
   Float_t         gedNeuIso;
   Float_t         gedPhPixSeed;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("20INF.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("20INF.root");
      }
      f->GetObject("t1",tree);
...
void CutID::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("gedPhSieie2012", &gedPhSieie2012, &b_gedPhSieie2012);
