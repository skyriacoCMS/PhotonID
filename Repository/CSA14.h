...
#ifdef CSA14_cxx
CSA14::CSA14(TTree *tree) : fChain(0){
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/cms/kyriacou/Samples/Photons/job_spring14_gjet_pt40_20bx25.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/cms/kyriacou/Samples/Photons/job_spring14_gjet_pt40_20bx25.root");
      }      
      TDirectory * dir = (TDirectory*)f->Get("/cms/kyriacou/Samples/Photons/job_spring14_gjet_pt40_20bx25.root:/ggNtuplizer");     
...
Int_t CSA14::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CSA14::LoadTree(Long64_t entry)
{
...
void CSA14::Show(Long64_t entry)
{
...
Int_t CSA14::Cut(Long64_t entry)
{
